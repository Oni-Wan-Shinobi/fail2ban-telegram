...
# SSH Brute-Force Protection v28

## Что делает скрипт

Автоматически защищает SSH на Debian-based системах от брутфорс-атак с уведомлениями в Telegram. Скрипт устанавливает двухуровневую систему блокировки: обнаруживает атакующих, блокирует их и сообщает вам об этом в реальном времени — на русском или английском языке на ваш выбор.
...
banstats        # статистика банов (текущие и всего)
...
Automatically protects SSH on Debian-based systems against brute-force attacks with Telegram notifications. The script sets up a two-layer blocking system: it detects attackers, blocks them, and reports every event to you in real time — in English or Russian, your choice.
...
banstats        # ban statistics (current and total)
